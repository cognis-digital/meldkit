...
def to_stix(observations, resolved, created: str = _STIX_TS) -> dict:
    ...
    docs/INTEROP.md."""
    objects = []
    ident = _sid("identity", "Cognis Vanguard Fusion")
    objects.append({"type": "identity", "spec_version": "2.1", "id": ident,
                    "created": created, "modified": created,
                    "name": "Cognis Vanguard Fusion", "identity_class": "system"})
    ...
    return {"type": "bundle", "id": _sid("bundle", "cognis-vanguard-fusion:" + created),
            "objects": objects}
